...
st.title("📊 Marketing Mix Modeling — Streamlit App")
...
if 'data' not in st.session_state:
    if USE_BETA_MODULE:
        try:
            ...
            st.warning("beta_mmm.load_and_preprocess_data failed — used fallback loader.")
    else:
        data = fallback_load(uploaded_file)
    ...
    if st.button("Run EDA", key="run_eda"):
        if USE_BETA_MODULE:
            try:
                ...
                st.warning("beta_mmm.perform_comprehensive_eda failed — running EDA fallback.")
